// src/features/Editor/renderers/TemplateContainerRenderer.tsx
import { useState, useEffect, useRef } from 'react';
import { useAtomValue, useSetAtom } from 'jotai';
import TextareaAutosize from 'react-textarea-autosize';
import { canvasComponentsByIdAtom, commitActionAtom } from '../../../data/historyAtoms';
import { LayoutComponent, WidgetComponent } from '../../../types';
...
export const TemplateContainerRenderer = ({ component }: RendererProps<LayoutComponent>) => {
