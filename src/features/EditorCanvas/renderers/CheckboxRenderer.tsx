// src/features/EditorCanvas/renderers/CheckboxRenderer.tsx
  ...
  return (
    <div className={styles.promptElementContent}>
      <div className={styles.checkboxExample}>
        ...
        <label className={styles.promptElementLabel} style={{ marginBottom: 0 }}>
          {label}
...
// --- Unified Renderer ---
export const CheckboxRenderer = ({ component, mode }: RendererProps<WidgetComponent>) => {
