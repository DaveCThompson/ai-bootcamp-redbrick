// src/features/EditorCanvas/CanvasContextMenu.tsx
...
const MenuContent = () => {
  ...
  const menuItems = useMemo<(ActionMenuItem | 'separator')[]>(() => {
    ...
    if (selectedIds.length > 1) {
      return [
        { id: 'wrap-multi', icon: 'add_box', label: 'Wrap in Group', onClick: actions.handleWrap, disabled: !capabilities.canWrap },
